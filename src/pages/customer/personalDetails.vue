          ...
          <div class="col-12 col-md-8 flex q-mt-lg">
            <div class="flex column">
              ...
              <div class="">
                ...
                <div v-if="!skipCustomerKBACheck && typeOfKBA !== 'foreigners_without_residential'" class="q-pt-lg">
...
export default {
  ...
  methods: {
    ...
    async savePersonalDetails () {
      ...
      if (!this.userState && !this.skipCustomerKBACheck && this.typeOfKBA !== "foreigners_without_residential") {
        return this.$q.notify({
          color: "secondary",
          position: "bottom-right",
      ...
      if (!this.addressLine1 && !this.skipCustomerKBACheck && this.typeOfKBA !== "foreigners_without_residential") {
        return this.$q.notify({
          color: "secondary",
          position: "bottom-right",
      ...
      if (!this.userZipCode && !this.skipCustomerKBACheck && this.typeOfKBA !== "foreigners_without_residential") {
        return this.$q.notify({
          color: "secondary",
          position: "bottom-right",
      ...
      if (res && !this.calledFromBusinessPage) {
        let nextStage = "photoid_check_stage";
      ...
      if (this.calledFromBusinessPage) {
        let tempNextStage = "photoid_check_stage";
        if (!this.skipCustomerKBACheck) {
