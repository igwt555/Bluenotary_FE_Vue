          ...
          <div class="">
            <q-card>
              ...
              >
                ...
                <q-tab v-if="!$user.memberTypeProWhenInvited" name="billing_payouts" label="Billing/Payouts" />
              </q-tabs>
...
export default {
  ...
  methods: {
    ...
    isAccountDetailUpdated () {
      ...
      if (this.accountDataLoaded === false || this.firstName !== this.oldData.first_name || this.lastName !== this.oldData.last_name || this.state !== this.oldData.state || this.commissionNumber !== this.oldData.commissionNumber || this.commistionExpiration !== this.oldData.commissionExpiresOn || this.email !== this.oldData.email) {
        return true;
      }
      return false;
    },
