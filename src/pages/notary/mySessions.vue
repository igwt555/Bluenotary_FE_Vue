                  ...
                  >
                    <template v-slot:header>
                      <div class="row " style="width:100%;align-items: flex-start;">
                        <div class="text-left cols-ss col-md-2 col-sm-4 col-12">
                        ...
                        <div class="text-left cols-psign col-md-3 col-sm-4 col-12">
                        ...
                        <div v-else-if="session.session.status === 'unsigned' && $user.memberType !== 'free'" class="text-right cols-gtses">
                          <div style="font-size: 10px; line-height: 13px">Signer hasn’t joined yet</div>
                          <router-link :to="'/pdf_edit/sessions/' + session.session._id">
                            <q-btn class="" color="pink" text-color="white" label="Pre-Tag">
                              <q-tooltip>
                      ...
                      <q-btn v-if="!showArchievedSessions && showArchieveButton(session)" outline color="red" icon="archive" style="margin-left: 10px; float: right" @click="archiveClicked(session.session._id)">
                        <q-tooltip>Click here to Archive the session</q-tooltip>
                      </q-btn>
                      <q-btn v-if="showArchievedSessions && showArchieveButton(session)" outline color="blue" icon="unarchive" style="margin-left: 10px; float: right" @click="unarchiveClicked(session.session._id)">
                        ...
                        <q-list>
                          ...
                          <q-item>
                            <q-item-section>
                              ...
                              <q-item-label>
                                {{ getKBAType(session) }}
                                <div v-if="session.idcardState">
                                  State : {{ session.idcardState }}
                                </div>
                                <div v-if="session.idcardExpiry">
                                  Expiry : {{ session.idcardExpiry }}
                                </div>
                              </q-item-label>
                            </q-item-section>
                          </q-item>
                          <q-item>
                            <q-item-section>
                              <q-item-label overline>Result of the identity proofing and credential analysis</q-item-label>
                              <q-item-label>
                          ...
                          <q-item>
                            <q-item-section>
                              ...
                              <q-item-label>
                                <a @click="auditTrailClicked(session)">View Audit Logs</a>
                              </q-item-label>
                            </q-item-section>
                          </q-item>
                        </q-list>
