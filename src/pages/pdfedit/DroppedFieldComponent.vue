<template>
  <div :id="'droppedFieldComponentInner' + fieldDroppedIndex" style="height: 100%; width: 100%" :style="innerFieldStyle" @click="placeholderSignatureClicked">
    <q-icon v-if="canEditElement && fieldType === 'static_text'" style="position: absolute; float: right: top: -10px; right: -15px; cursor: pointer;" name="content_copy" @click="copyDroppedElementToAllPagesLocal($event, elementId)">
